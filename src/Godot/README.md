_This package is a meta package that simplifies referencing all recommended Godot packages._
...
<!-- TODO: Remove note when we gain support for all platforms. -->
*: Some platforms may not be supported when using the .NET bindings. See [C# platform support](https://docs.godotengine.org/en/stable/tutorials/scripting/c_sharp/index.html#c-platform-support) for more information.
